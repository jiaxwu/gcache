...
func (z *SortedSet) ZAdd(key string, score int64, member string) {
	if !z.exist(key) {
...
func (z *SortedSet) ZScore(key string, member string) (ok bool, score int64) {
	if !z.exist(key) {
		return
	}
...
func (z *SortedSet) ZIncrBy(key string, increment int64, member string) int64 {
	if z.exist(key) {
		node, exist := z.record[key].dict[member]
		if exist {
...
func (z *SortedSet) getByRank(key string, rank int64, reverse bool) (string, int64) {
...
func sklNewNode(level int16, score int64, member string) *sklNode {
	node := &sklNode{
		score:  score,
		member: member,
...
func (skl *skipList) sklInsert(score int64, member string) *sklNode {
...
func (skl *skipList) sklDelete(score int64, member string) {
...
func (skl *skipList) sklGetRank(score int64, member string) int64 {
	var rank uint64 = 0
	p := skl.head
